...
/**
 * <p>Clase Java para PersonToPersonAuthenticateResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PersonToPersonAuthenticateResponse"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="errors" type="{http://www.morpho.com/mbss/generic/wsdl}PersonToPersonAuthenticateError" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "PersonToPersonAuthenticateResponse", propOrder = {
    "basicResponse",
    "candidate",
    "errors",
    "noHitRank"
})
public class PersonToPersonAuthenticateResponse {

    @XmlElement(required = true)
    protected BasicResponse basicResponse;
    protected List<Candidate> candidate;
    protected List<PersonToPersonAuthenticateError> errors;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PersonToPersonAuthenticateError }
     * 
     * 
     */
    public List<PersonToPersonAuthenticateError> getErrors() {
        if (errors == null) {
            errors = new ArrayList<PersonToPersonAuthenticateError>();
        }
        return this.errors;
    }
